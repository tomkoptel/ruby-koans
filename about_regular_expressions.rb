...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # There is no preceding matching for the group of expected symbols
  end
  ...
  # Character classes ([...]) are optimized for matching one out of some set of characters, and alternatives (x|y) allow
  # for more general choices of varying lengths. You will tend to see better performance if you keep these design
  # principles in mind. Regex implementations transform source code such as /[abc]/ into finite-state automata, usually NFAs.
  # What we think of as regex engines are more-or-less bookkeepers that assist execution of those target state machines.
  # The sufficiently smart regex compiler will generate the same machine code for equivalent regexes, but this is
  # difficult and expensive in the general case because of the lurking exponential complexity.
